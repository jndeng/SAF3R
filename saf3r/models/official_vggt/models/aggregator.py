...
class Aggregator(nn.Module):
    ...
    def __init__(
        ...
        # whether to save all intermediate outputs or just the blocks with indices in DPT_BLOCKS
    ...
    def _process_frame_attention(self, tokens, B, S, P, C, frame_idx, pos=None, save_feats=True):
        """
    ...
    def _process_global_attention(self, tokens, B, S, P, C, global_idx, pos=None, save_feats=True):
        """
