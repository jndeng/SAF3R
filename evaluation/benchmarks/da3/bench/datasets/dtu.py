...
from ..registries import MONO_REGISTRY, MV_REGISTRY
...
from ...pose_align import align_poses_umeyama
        ...
        out = Dict(
            {
                ...
                "intrinsics": [],
                "aux": Dict({
                    "gt_pcd_path": os.path.join(self.data_root, f"Points/stl/stl{scene_id:03}_total.ply"),
                    "mask_file": os.path.join(self.data_root, f"SampleSet/mvs_data/ObsMask/ObsMask{scene_id}_10.mat"),
                    "plane_file": os.path.join(self.data_root, f"SampleSet/mvs_data/ObsMask/Plane{scene_id}.mat"),
                    "mask_files": [],
                }),
            }
        )
